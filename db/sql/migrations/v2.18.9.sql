...
alter table `project__device` add column `ansible_password` longtext not null default '';
...
alter table `project__device_settings` add column `default_ansible_password` longtext not null default '';

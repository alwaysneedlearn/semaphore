export default {
  ...
  deviceDiscoverySettingsHelp:
    'Project-level discovery template (not tied to a device type). Task output is parsed into the list below.',
  deviceDiscoveryDefaultInventory: 'Default inventory (optional)',
  deviceDiscoveryTemplateRequired: 'Configure a discovery template above before running a scan.',
  ...
  deviceDiscoveryHelp:
    'Enter a subnet and run the discovery template. Results appear in the table; choose a device type, then import selected rows.',

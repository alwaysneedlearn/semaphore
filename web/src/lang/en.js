export default {
  ...
  deviceResendHintMixed: 'Times are converted per device type in the playbook (NBT date-only, NEWARE yyyy-MM-dd, etc.)',
  ...
  deviceResendHintLANDV7: 'LANDV7: Redeliver API (same as LANH), yyyy-M-d HH:mm:ss',
  deviceResendHintSINEXCEL: 'SINEXCEL: Retransmit API, yyyy-M-d HH:mm:ss',
  deviceResendHintJHAI: 'JHAI: partial resend uses testStartTime / testEndTime',
  ...
  deviceResendNoEligible: 'No selected device has a resend template configured',
  ...
  deviceResendUnsupportedSkipped: 'Skipped {count} device(s) without a resend template',

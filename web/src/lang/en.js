export default {
  ...
  deviceDiscoveryHelp: 'Input subnet and run discovery template to scan devices. Then paste discovered JSON and import selected hostnames.',
  deviceDiscoverySubnet: 'Subnet (template variable)',
  deviceDiscoverySubnetHint: 'Sent to discovery template as subnet and network_cidr, e.g. 192.168.1.0/24',

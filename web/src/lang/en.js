export default {
  ...
  deviceDiscoveryHelp: 'Paste the discovered device JSON list, then select which hostnames should be added or updated in the device list (hostname is unique).',

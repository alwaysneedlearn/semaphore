export default {
  ...
  deviceResendHintMixed: '各设备类型将在 playbook 中转换为对应 API 时间格式（NBT 仅日期，NEWARE 为 yyyy-MM-dd 等）',
  ...
  deviceResendHintJHAI: 'JHAI：分段重传 testStartTime / testEndTime',
  ...
  deviceResendNoEligible: '所选设备均未配置重发数据模板',
  ...
  deviceResendUnsupportedSkipped: '已跳过 {count} 台未配置重发模板的设备',
